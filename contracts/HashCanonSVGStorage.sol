...
contract HashCanonSVGStorage {
    ...
    constructor() {
        ...
        headPtr = SSTORE2.write(
            // <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" preserveAspectRatio="xMidYMid meet" stroke="black" stroke-width="1"><defs><symbol id="sectorShape"><path id="r0" d="M 512 112 A 400 400 0 0 1 551.2068 113.9261 L 559.0482 34.3113 A 480 480 0 0 0 512 32 Z"/><path id="r1" d="M 512 192 A 320 320 0 0 1 543.3654 193.5408 L 551.2068 113.9261 A 400 400 0 0 0 512 112 Z"/><path id="r2" d="M 512 272 A 240 240 0 0 1 535.5241 273.1556 L 543.3654 193.5408 A 320 320 0 0 0 512 192 Z"/><path id="r3" d="M 512 352 A 160 160 0 0 1 527.6827 352.7704 L 535.5241 273.1556 A 240 240 0 0 0 512 272 Z"/></symbol></defs><rect x="0" y="0" width="1024" height="1024" fill="black" stroke-width="0"/>
